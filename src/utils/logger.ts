...
export type CreateLoggerFunction = (moduleName: string) => Logger
...
formatters.d = (v?: number | bigint): string => {
 ...
 *
 * NOTE: This is exported because it needs to be exposed for the logger to work but you should use `createLogger` in
...
export const createLogger = (
...
): ((moduleName?: string | undefined) => Logger) => {
  return (moduleName?: string | undefined) => {
    ...
    return new Logger(name, writeToQueue, filename)
  }
}

export const createModuleLogger = createLogger("cp2077")
